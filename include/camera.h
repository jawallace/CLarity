...
public:
    ...
    typedef std::tuple<double, double, double> Pointing_Vector;
    ...
    Camera(const double field_of_view_rad,
           const uint16_t rows, 
           const uint16_t cols);
    ...
    void set_fov(const double fov_rad);
